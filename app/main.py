...
class Pessoa:
    ...
    nome: Mapped[str] = mapped_column(default='Gustavo')
...
@app.post('/pessoas', response_model=PessoaSchemaOut)
def create(pessoa: PessoaSchemaIn):
    if pessoa.nome == 'augusto':
        with tracer.start_as_current_span('case do augusto'):
            pessoa.nome = 'Tugo'
